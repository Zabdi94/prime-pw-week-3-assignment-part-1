...
let favoriteFoods = ['lasagna, pizza, pasta, wings']
...
console.log('Added new food at the end,', favoriteFoods);
...
console.log('removed the variable', removedFoods);
...
console.log(`added donut to beginning: ${favoriteFoods}`);
